...
public class Adapter_ChatMessage extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (!TextUtils.isEmpty(mChatMessage.getContent())) {
            holder.tv_text.setText(mChatMessage.getContent());
            holder.tv_text.setVisibility(View.VISIBLE);
            holder.ivImage.setVisibility(View.GONE);
        } else if (mChatMessage.getImagePath() != null) {
            Glide.with(context)
                    .load(mChatMessage.getImagePath())
                    .into(holder.ivImage);
...
//        holder.tv_text.setText(content);
    ...
    class ViewHolder {
        private TextView tv_text, tv_sendtime, tv_display_name, tv_isRead;
