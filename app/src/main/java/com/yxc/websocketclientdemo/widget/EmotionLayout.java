//package com.yxc.websocketclientdemo.widget;
//
...
//import com.lqr.emoji.EmotionViewPagerAdapter;
...
//        emotionLayout = inflater.inflate(com.lqr.emoji.R.layout.emotion_layout, this);
//
//        mVpEmotioin = (ViewPagerFixed) findViewById(com.lqr.emoji.R.id.vpEmotioin);
//        mLlPageNumber = (LinearLayout) findViewById(com.lqr.emoji.R.id.llPageNumber);
//        mLlTabContainer = (LinearLayout) findViewById(com.lqr.emoji.R.id.llTabContainer);
//        mRlEmotionAdd = (RelativeLayout) findViewById(com.lqr.emoji.R.id.rlEmotionAdd);
//
...
//        //默认添加一个表情tab
//        EmotionTab emojiTab = new EmotionTab(mContext, com.lqr.emoji.R.drawable.ic_tab_emoji);
//        mTabCount = 1;
...
//            mSettingTab = new EmotionTab(mContext, com.lqr.emoji.R.drawable.ic_emotion_setting);
//            StateListDrawable drawable = new StateListDrawable();
//            Drawable unSelected = mContext.getResources().getDrawable(com.lqr.emoji.R.color.white);
//            drawable.addState(new int[]{-android.R.attr.state_pressed}, unSelected);
//            Drawable selected = mContext.getResources().getDrawable(com.lqr.emoji.R.color.gray);
...
//        if (mTabPosi == 0)
//            setCategoryPageIndexIndicator(position, (int) Math.ceil(EmojiManager.getDisplayCount() / (float) com.lqr.emoji.EmotionLayout.EMOJI_PER_PAGE));
//        else {
//            StickerCategory category = StickerManager.getInstance().getStickerCategories().get(mTabPosi - 1);
//            setCategoryPageIndexIndicator(position, (int) Math.ceil(category.getStickers().size() / (float) com.lqr.emoji.EmotionLayout.STICKER_PER_PAGE));
//        }
//        selectTab(mTabPosi);
//    }
//
...
//            tab.setBackgroundResource(com.lqr.emoji.R.drawable.shape_tab_normal);
//        }
//        mTabViewArray.get(tabPosi).setBackgroundResource(com.lqr.emoji.R.drawable.shape_tab_press);
//
//    }
//
...
//                    ivCur.setBackgroundResource(com.lqr.emoji.R.drawable.selector_view_pager_indicator);
